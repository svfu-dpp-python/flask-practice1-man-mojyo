...
В отличии от метода GET, при использовании метода POST аргументы в url адресе нашего сервера не меняют своих значений при отправке данных на сервер пользователем
